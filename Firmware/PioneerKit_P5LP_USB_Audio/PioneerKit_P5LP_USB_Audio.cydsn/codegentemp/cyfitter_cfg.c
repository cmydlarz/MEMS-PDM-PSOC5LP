...
#define BS_IDMUX_VAL ((const uint8 CYFAR *)(0x48001238u + CYAPP_ECC_OFFSET))

/* UDB_0_0_1_CONFIG Address: CYDEV_UCFG_B1_P5_U1_BASE Size (bytes): 128 */
#define BS_UDB_0_0_1_CONFIG_VAL ((const uint8 CYFAR *)(0x48001240u + CYAPP_ECC_OFFSET))

/* UCFG_BCTL0 Address: CYREG_BCTL0_MDCLK_EN Size (bytes): 16 */
#define BS_UCFG_BCTL0_VAL ((const uint8 CYFAR *)(0x480012C0u + CYAPP_ECC_OFFSET))

/* IOPINS0_0 Address: CYREG_PRT0_DM0 Size (bytes): 8 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)(0x480012D0u + CYAPP_ECC_OFFSET))

/* IOPINS0_7 Address: CYREG_PRT12_DM0 Size (bytes): 8 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)(0x480012D8u + CYAPP_ECC_OFFSET))

/* IOPINS0_8 Address: CYREG_PRT15_DR Size (bytes): 10 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)(0x480012E0u + CYAPP_ECC_OFFSET))
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)(0x48001304u + CYAPP_ECC_OFFSET))
...
#define BS_PHUB_CFGMEM11_VAL ((const uint8 CYFAR *)(0x48001314u + CYAPP_ECC_OFFSET))

/* PHUB_CFGMEM12 Address: CYREG_PHUB_CFGMEM12_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM12_VAL ((const uint8 CYFAR *)(0x48001318u + CYAPP_ECC_OFFSET))

/* PHUB_CFGMEM13 Address: CYREG_PHUB_CFGMEM13_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM13_VAL ((const uint8 CYFAR *)(0x4800131Cu + CYAPP_ECC_OFFSET))

/* PHUB_CFGMEM2 Address: CYREG_PHUB_CFGMEM2_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM2_VAL ((const uint8 CYFAR *)(0x48001320u + CYAPP_ECC_OFFSET))

/* PHUB_CFGMEM8 Address: CYREG_PHUB_CFGMEM8_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM8_VAL ((const uint8 CYFAR *)(0x48001324u + CYAPP_ECC_OFFSET))
