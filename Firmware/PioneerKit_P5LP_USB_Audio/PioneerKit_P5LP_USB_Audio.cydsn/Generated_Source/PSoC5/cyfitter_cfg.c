...
#define BS_IDMUX_VAL ((const uint8 CYFAR *)(0x4800114Cu + CYAPP_ECC_OFFSET))

/* IDMUX_IRQ Address: CYREG_IDMUX_IRQ_CTL0 Size (bytes): 8 */
#define BS_IDMUX_IRQ_VAL ((const uint8 CYFAR *)(0x48001154u + CYAPP_ECC_OFFSET))

/* UDB_1_3_1_CONFIG Address: CYDEV_UCFG_B0_P2_U1_BASE Size (bytes): 128 */
#define BS_UDB_1_3_1_CONFIG_VAL ((const uint8 CYFAR *)(0x4800115Cu + CYAPP_ECC_OFFSET))

/* UDB_1_1_0_CONFIG Address: CYDEV_UCFG_B1_P3_U1_BASE Size (bytes): 128 */
#define BS_UDB_1_1_0_CONFIG_VAL ((const uint8 CYFAR *)(0x480011DCu + CYAPP_ECC_OFFSET))

/* UDB_0_1_1_CONFIG Address: CYDEV_UCFG_B1_P4_U0_BASE Size (bytes): 128 */
#define BS_UDB_0_1_1_CONFIG_VAL ((const uint8 CYFAR *)(0x4800125Cu + CYAPP_ECC_OFFSET))

/* UCFG_BCTL0 Address: CYREG_BCTL0_MDCLK_EN Size (bytes): 16 */
#define BS_UCFG_BCTL0_VAL ((const uint8 CYFAR *)(0x480012DCu + CYAPP_ECC_OFFSET))

/* IOPINS0_0 Address: CYREG_PRT0_DM0 Size (bytes): 8 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)(0x480012ECu + CYAPP_ECC_OFFSET))

/* IOPINS0_7 Address: CYREG_PRT12_DM0 Size (bytes): 8 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)(0x480012F4u + CYAPP_ECC_OFFSET))

/* IOPINS0_8 Address: CYREG_PRT15_DR Size (bytes): 10 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)(0x480012FCu + CYAPP_ECC_OFFSET))

/* IOPINS0_1 Address: CYREG_PRT1_DR Size (bytes): 10 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)(0x48001308u + CYAPP_ECC_OFFSET))

/* IOPINS0_2 Address: CYREG_PRT2_DR Size (bytes): 10 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)(0x48001314u + CYAPP_ECC_OFFSET))

/* IOPINS0_3 Address: CYREG_PRT3_DR Size (bytes): 10 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)(0x48001320u + CYAPP_ECC_OFFSET))

/* PHUB_CFGMEM11 Address: CYREG_PHUB_CFGMEM11_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM11_VAL ((const uint8 CYFAR *)(0x4800132Cu + CYAPP_ECC_OFFSET))

/* PHUB_CFGMEM12 Address: CYREG_PHUB_CFGMEM12_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM12_VAL ((const uint8 CYFAR *)(0x48001330u + CYAPP_ECC_OFFSET))

/* PHUB_CFGMEM13 Address: CYREG_PHUB_CFGMEM13_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM13_VAL ((const uint8 CYFAR *)(0x48001334u + CYAPP_ECC_OFFSET))

/* PHUB_CFGMEM14 Address: CYREG_PHUB_CFGMEM14_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM14_VAL ((const uint8 CYFAR *)(0x48001338u + CYAPP_ECC_OFFSET))

/* PHUB_CFGMEM2 Address: CYREG_PHUB_CFGMEM2_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM2_VAL ((const uint8 CYFAR *)(0x4800133Cu + CYAPP_ECC_OFFSET))

/* PHUB_CFGMEM4 Address: CYREG_PHUB_CFGMEM4_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM4_VAL ((const uint8 CYFAR *)(0x48001340u + CYAPP_ECC_OFFSET))

/* PHUB_CFGMEM8 Address: CYREG_PHUB_CFGMEM8_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM8_VAL ((const uint8 CYFAR *)(0x48001344u + CYAPP_ECC_OFFSET))
...
void cyfitter_cfg(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)(CYREG_B0_P4_U0_CFG24), 0x84u);
	CY_SET_XTND_REG8((void CYFAR *)(CYREG_B1_P2_U0_CFG24), 0x44u);
