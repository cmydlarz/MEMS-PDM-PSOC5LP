...
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
"C:\Program Files\Cypress\PSoC Creator\2.2\PSoC Creator\bin\cyhextool" -o "%~1\%~2\%~n3.hex" -f "%~1\%~2\%~n3.ihx" -flsLine 256 -arraySize 65536 -id 2E127069 -rev 0 -ecc "%~dp0config.hex" -metaRow 0 -blver 00020000000100000000 -chksumEcc -blChkType 0 -endian l -a EEPROM=90200000:800,PROGRAM=00000000:40000,CONFIG=80000000:8000,PROTECT=90400000:100 -acd -acdStart 2800 -e "%~1\%~2\entryaddress.txt" 
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
"C:\Program Files\Cypress\PSoC Creator\2.2\PSoC Creator\bin\cyhextool" -o "%~1\%~2\%~n3.hex" -flsLine 256 -arraySize 65536 -bl ..\Programmer\KitProg_Bootloader\KitProg_Bootloader.hex -blver 00020000000100000000 -chksumEcc -blChkType 0 -endian l -prot "%~dp0protect.hex" -id 2E127069 -a EEPROM=90200000:800,PROGRAM=00000000:40000,CONFIG=80000000:8000,PROTECT=90400000:100 -meta 0001 -cunv 00004007 -wonv BC90ACAF -ecc "%~dp0config.hex" -ld "%~1\%~2\%~n3.ihx=2800:3D7BF" -acdStart 2800 -e "%~1\%~2\entryaddress.txt" 
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "\\psf\Home\Desktop\USB-audio\Firmware\PioneerKit_P5LP_USB_Audio\PioneerKit_P5LP_USB_Audio.cydsn\PioneerKit_P5LP_USB_Audio.svd" rem "\\psf\Home\Desktop\USB-audio\Firmware\PioneerKit_P5LP_USB_Audio\PioneerKit_P5LP_USB_Audio.cydsn\PioneerKit_P5LP_USB_Audio.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
