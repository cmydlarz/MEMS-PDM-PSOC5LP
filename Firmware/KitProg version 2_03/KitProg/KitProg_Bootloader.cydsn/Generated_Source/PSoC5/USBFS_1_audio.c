...
***************************************/
    ...
    volatile uint8 USBFS_1_minimumVolume[] = {0x01, 0x80};
    volatile uint8 USBFS_1_maximumVolume[] = {0xFF, 0x7F};
    volatile uint8 USBFS_1_resolutionVolume[] = {0x01, 0x00};
...
*
*******************************************************************************/
uint8 USBFS_1_DispatchAUDIOClassRqst() 
{
