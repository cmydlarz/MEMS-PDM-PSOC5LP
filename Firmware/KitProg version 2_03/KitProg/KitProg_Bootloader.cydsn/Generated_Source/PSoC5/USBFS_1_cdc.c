    ...
    *******************************************************************************/
    uint32 USBFS_1_GetDTERate(void) 
    {
        ...
        /* Data terminal rate has little endian format. */
            ...
            ((uint8 *)&rate)[0u] = USBFS_1_lineCoding[USBFS_1_LINE_CODING_RATE + 3u];
            ((uint8 *)&rate)[1u] = USBFS_1_lineCoding[USBFS_1_LINE_CODING_RATE + 2u];
            ((uint8 *)&rate)[2u] = USBFS_1_lineCoding[USBFS_1_LINE_CODING_RATE + 1u];
            ((uint8 *)&rate)[3u] = USBFS_1_lineCoding[USBFS_1_LINE_CODING_RATE];
        #elif defined(__GNUC__) || defined(__ARMCC_VERSION)
            /* ARM compilers (GCC and RealView) are little-endian */
            USBFS_1_CONVERT_DWORD *convert =
                (USBFS_1_CONVERT_DWORD *)&USBFS_1_lineCoding[USBFS_1_LINE_CODING_RATE];
            rate = convert->dword;
