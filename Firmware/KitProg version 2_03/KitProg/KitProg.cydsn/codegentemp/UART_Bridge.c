...
uint8 UART_Bridge_initVar = 0u;
    ...
    volatile uint8 UART_Bridge_txBuffer[UART_Bridge_TXBUFFERSIZE];
    volatile uint8 UART_Bridge_txBufferRead = 0u;
    uint8 UART_Bridge_txBufferWrite = 0u;
    ...
    volatile uint8 UART_Bridge_rxBuffer[UART_Bridge_RXBUFFERSIZE];
    volatile uint8 UART_Bridge_rxBufferRead = 0u;
    volatile uint8 UART_Bridge_rxBufferWrite = 0u;
    ...
    volatile uint8 UART_Bridge_rxBufferOverflow = 0u;
        ...
        volatile uint8 UART_Bridge_rxAddressMode = UART_Bridge_RXADDRESSMODE;
...
*  to the UART_Bridge_Start() routine.
*
* Reentrant:
*  No.
*
...
void UART_Bridge_Init(void) 
{
        ...
        #if(UART_Bridge_RX_INTERRUPT_ENABLED && (UART_Bridge_RXBUFFERSIZE > UART_Bridge_FIFO_LENGTH))
        ...
        #endif /* End UART_Bridge_RX_INTERRUPT_ENABLED */

        #if (UART_Bridge_RXHW_ADDRESS_ENABLED)
            UART_Bridge_SetRxAddressMode(UART_Bridge_RXAddressMode);
            UART_Bridge_SetRxAddress1(UART_Bridge_RXHWADDRESS1);
            UART_Bridge_SetRxAddress2(UART_Bridge_RXHWADDRESS2);
        ...
        #if(UART_Bridge_TX_INTERRUPT_ENABLED && (UART_Bridge_TXBUFFERSIZE > UART_Bridge_FIFO_LENGTH))
        ...
        /* Write Counter Value for TX Bit Clk Generator*/
            ...
            UART_Bridge_TXBITCLKTX_COMPLETE_REG = (UART_Bridge_NUMBER_OF_DATA_BITS +
                        UART_Bridge_NUMBER_OF_START_BIT) * UART_Bridge_OVER_SAMPLE_COUNT;
        #else
...
void UART_Bridge_Enable(void) 
{
    ...
    enableInterrupts = CyEnterCriticalSection();
        ...
        #if(UART_Bridge_RX_INTERRUPT_ENABLED && (UART_Bridge_RXBUFFERSIZE > UART_Bridge_FIFO_LENGTH))
            CyIntEnable(UART_Bridge_RX_VECT_NUM);
            #if (UART_Bridge_RXHW_ADDRESS_ENABLED)
        ...
        #if(UART_Bridge_TX_INTERRUPT_ENABLED && (UART_Bridge_TXBUFFERSIZE > UART_Bridge_FIFO_LENGTH))
            CyIntEnable(UART_Bridge_TX_VECT_NUM);
        #endif /* End UART_Bridge_TX_INTERRUPT_ENABLED*/
     #endif /* End UART_Bridge_TX_ENABLED */
...
void  UART_Bridge_WriteControlRegister(uint8 control) 
{
       ...
       UART_Bridge_CONTROL_REG = control;
        ...
        /*******************************************************************************
        * Function Name: UART_Bridge_EnableRxInt
        ********************************************************************************
        *
        * Summary:
        ...
        *
        *******************************************************************************/
        void UART_Bridge_EnableRxInt(void) 
        {
            CyIntEnable(UART_Bridge_RX_VECT_NUM);
        }
        ...
        /*******************************************************************************
        * Function Name: UART_Bridge_DisableRxInt
        ********************************************************************************
        *
        * Summary:
        ...
        *
        *******************************************************************************/
        void UART_Bridge_DisableRxInt(void) 
        {
            CyIntDisable(UART_Bridge_RX_VECT_NUM);
        }
    ...
    *  UART_Bridge_rxBufferLoopDetect - creared if loop condition was detected
    *     in RX ISR.
    *
    * Reentrant:
    *  No.
    ...
    *******************************************************************************/
    uint8 UART_Bridge_ReadRxData(void) 
    {
        uint8 rxData;
        ...
        #if(UART_Bridge_RXBUFFERSIZE > UART_Bridge_FIFO_LENGTH)
            ...
            /* Disable Rx interrupt. */
                ...
                UART_Bridge_DisableRxInt();
            #endif /* UART_Bridge_RX_INTERRUPT_ENABLED */
            loc_rxBufferRead = UART_Bridge_rxBufferRead;
            loc_rxBufferWrite = UART_Bridge_rxBufferWrite;

            if( (UART_Bridge_rxBufferLoopDetect != 0u) || (loc_rxBufferRead != loc_rxBufferWrite) )
            {
                rxData = UART_Bridge_rxBuffer[loc_rxBufferRead];
                loc_rxBufferRead++;

                if(loc_rxBufferRead >= UART_Bridge_RXBUFFERSIZE)
                {
                    loc_rxBufferRead = 0u;
                }
                /* Update the real pointer */
                UART_Bridge_rxBufferRead = loc_rxBufferRead;
        ...
        #else /* UART_Bridge_RXBUFFERSIZE > UART_Bridge_FIFO_LENGTH */

            /* Needs to check status for RX_STS_FIFO_NOTEMPTY bit*/
            rxData = UART_Bridge_RXDATA_REG;

        #endif /* UART_Bridge_RXBUFFERSIZE > UART_Bridge_FIFO_LENGTH */
    ...
    *******************************************************************************/
    uint8 UART_Bridge_ReadRxStatus(void) 
    {
        ...
        #endif /* UART_Bridge_RXBUFFERSIZE */
    ...
    *
    *******************************************************************************/
    uint8 UART_Bridge_GetRxBufferSize(void)
                                                            
    {
        uint8 size;
            ...
            {
                size = (UART_Bridge_RXBUFFERSIZE - UART_Bridge_rxBufferRead) + UART_Bridge_rxBufferWrite;
            }
    ...
    *******************************************************************************/
    void UART_Bridge_ClearRxBuffer(void) 
    {
        ...
        enableInterrupts = CyEnterCriticalSection();
        UART_Bridge_RXDATA_AUX_CTL_REG |=  UART_Bridge_RX_FIFO_CLR;
    ...
    *******************************************************************************/
    void UART_Bridge_SetRxAddress2(uint8 address) 
    {
        ...
        /*******************************************************************************
        * Function Name: UART_Bridge_EnableTxInt
        ********************************************************************************
        *
        * Summary:
        ...
        *
        *******************************************************************************/
        void UART_Bridge_EnableTxInt(void) 
        {
            CyIntEnable(UART_Bridge_TX_VECT_NUM);
        }
        ...
        /*******************************************************************************
        * Function Name: UART_Bridge_DisableTxInt
        ********************************************************************************
        *
        * Summary:
        ...
        *
        *******************************************************************************/
        void UART_Bridge_DisableTxInt(void) 
        {
            CyIntDisable(UART_Bridge_TX_VECT_NUM);
        }
    ...
    *******************************************************************************/
    void UART_Bridge_WriteTxData(uint8 txDataByte) 
    {
        ...
        if(UART_Bridge_initVar != 0u)
        {
                ...
                {
                    if(UART_Bridge_txBufferWrite >= UART_Bridge_TXBUFFERSIZE)
                    {
    ...
    void UART_Bridge_PutChar(uint8 txDataByte) 
    {
                ...
                */
                ...
                do{
                    ...
                    #if ((UART_Bridge_TXBUFFERSIZE > UART_Bridge_MAX_BYTE_VALUE) && (CY_PSOC3))
                        /* Disable TX interrupt to protect variables that could change on interrupt */
                        CyIntDisable(UART_Bridge_TX_VECT_NUM);
                    #endif /* End TXBUFFERSIZE > 255 */
                    loc_txBufferWrite = UART_Bridge_txBufferWrite;
                    loc_txBufferRead = UART_Bridge_txBufferRead;
                    #if ((UART_Bridge_TXBUFFERSIZE > UART_Bridge_MAX_BYTE_VALUE) && (CY_PSOC3))
                        ...
                        CyIntEnable(UART_Bridge_TX_VECT_NUM);
                                        ...
                                        (uint8)(UART_Bridge_TXBUFFERSIZE - 1u)) );
                ...
                {
                    if(loc_txBufferWrite >= UART_Bridge_TXBUFFERSIZE)
                    {
                        loc_txBufferWrite = 0u;
                    }
                    /* Add to the software buffer. */
                    UART_Bridge_txBuffer[loc_txBufferWrite] = txDataByte;
                    loc_txBufferWrite++;
                    ...
                    /* Finally, update the real output pointer */
                        ...
                        CyIntDisable(UART_Bridge_TX_VECT_NUM);
                    #endif /* End TXBUFFERSIZE > 255 */
                    UART_Bridge_txBufferWrite = loc_txBufferWrite;
                    #if ((UART_Bridge_TXBUFFERSIZE > UART_Bridge_MAX_BYTE_VALUE) && (CY_PSOC3))
                        CyIntEnable(UART_Bridge_TX_VECT_NUM);
                    #endif /* End TXBUFFERSIZE > 255 */
                }
    ...
    *******************************************************************************/
    void UART_Bridge_PutString(const char8 string[]) 
    {
        ...
        if(UART_Bridge_initVar != 0u)
        {
            ...
            {
                UART_Bridge_PutChar((uint8)string[buf_index]);
                buf_index++;
            }
        }
    }
    ...
    *
    *******************************************************************************/
    void UART_Bridge_PutArray(const uint8 string[], uint8 byteCount)
                                                                    
    {
        ...
        if(UART_Bridge_initVar != 0u)
        {
            do
            {
                UART_Bridge_PutChar(string[buf_index]);
                buf_index++;
    ...
    *
    *******************************************************************************/
    uint8 UART_Bridge_GetTxBufferSize(void)
    ...
    *******************************************************************************/
    void UART_Bridge_ClearTxBuffer(void) 
    {
        ...
        enableInterrupts = CyEnterCriticalSection();
        /* clear the HW FIFO */
        UART_Bridge_TXDATA_AUX_CTL_REG |=  UART_Bridge_TX_FIFO_CLR;
        ...
        if(UART_Bridge_initVar != 0u)
        {
            ...
            uint8 tmpStat;
                    ...
                    (retMode == UART_Bridge_SEND_WAIT_REINIT) )
                {
                    ...
                    #if(UART_Bridge_TXCLKGEN_DP)
                        tx_period = UART_Bridge_TXBITCLKTX_COMPLETE_REG;
                        UART_Bridge_TXBITCLKTX_COMPLETE_REG = UART_Bridge_TXBITCTR_BREAKBITS;
                    #else
                        tx_period = UART_Bridge_TXBITCTR_PERIOD_REG;
                    ...
                    (retMode == UART_Bridge_SEND_WAIT_REINIT) )
                {
                    ...
                    #if(UART_Bridge_TXCLKGEN_DP)
                        UART_Bridge_TXBITCLKTX_COMPLETE_REG = tx_period;
                    #else
                        UART_Bridge_TXBITCTR_PERIOD_REG = tx_period;
                    #endif /* End UART_Bridge_TXCLKGEN_DP */
    ...
    *******************************************************************************/
    void UART_Bridge_LoadTxConfig(void) 
    {
        ...
        UART_Bridge_RXBITCTR_PERIOD_REG = UART_Bridge_HD_TXBITCTR_INIT;
            ...
            CY_GET_REG8(UART_Bridge_RXSTATUS_PTR);
        #endif /* CY_UDB_V0 */
    }
