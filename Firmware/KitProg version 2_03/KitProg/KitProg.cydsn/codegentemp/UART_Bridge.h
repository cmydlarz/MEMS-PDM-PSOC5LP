...
#define UART_Bridge_FLOW_CONTROL                   (0u)
#define UART_Bridge_CLK_FREQ                       (0u)
#define UART_Bridge_TXBUFFERSIZE                   (128u)
#define UART_Bridge_RXBUFFERSIZE                   (128u)
...
#define UART_Bridge_BIT_CENTER                         (UART_Bridge_OVER_SAMPLE_COUNT - 1u)
...
extern uint8 UART_Bridge_initVar;
    ...
    extern volatile uint8 UART_Bridge_txBuffer[UART_Bridge_TXBUFFERSIZE];
    extern volatile uint8 UART_Bridge_txBufferRead;
    extern uint8 UART_Bridge_txBufferWrite;
#endif /* End UART_Bridge_TX_ENABLED */
#if( ( UART_Bridge_RX_ENABLED || UART_Bridge_HD_ENABLED ) && \
     (UART_Bridge_RXBUFFERSIZE > UART_Bridge_FIFO_LENGTH) )
    extern volatile uint8 UART_Bridge_rxBuffer[UART_Bridge_RXBUFFERSIZE];
    extern volatile uint8 UART_Bridge_rxBufferRead;
    extern volatile uint8 UART_Bridge_rxBufferWrite;
...
#if (UART_Bridge_RXHW_ADDRESS_ENABLED)
    #define UART_Bridge_RXADDRESSMODE      (0u)
    #define UART_Bridge_RXHWADDRESS1       (0u)
    #define UART_Bridge_RXHWADDRESS2       (0u)
