...
#define Clock_UART_SetDivider(clkDivider)         Clock_UART_SetDividerRegister(clkDivider, 1)
#define Clock_UART_SetDividerValue(clkDivider)    Clock_UART_SetDividerRegister((clkDivider) - 1, 1)
...
#define Clock_UART_SetPhaseValue(clkPhase)        Clock_UART_SetPhaseRegister((clkPhase) + 1)
#endif /* defined(Clock_UART__CFG3) */
