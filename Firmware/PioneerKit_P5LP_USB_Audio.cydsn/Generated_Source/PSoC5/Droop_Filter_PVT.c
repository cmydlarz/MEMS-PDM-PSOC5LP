...
{
    events &= Droop_Filter_EVENT_MASK;
    Droop_Filter_INT_CTRL_REG = events;
}
...
{
    events &= Droop_Filter_DMA_CTRL_MASK;
    Droop_Filter_DMA_CTRL_REG = events;
}
