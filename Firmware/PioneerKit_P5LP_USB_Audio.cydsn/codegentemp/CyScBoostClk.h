...
#define CyScBoostClk_SetDivider(clkDivider)         CyScBoostClk_SetDividerRegister(clkDivider, 1)
#define CyScBoostClk_SetDividerValue(clkDivider)    CyScBoostClk_SetDividerRegister((clkDivider) - 1, 1)
...
#define CyScBoostClk_SetPhaseValue(clkPhase)        CyScBoostClk_SetPhaseRegister((clkPhase) + 1)
#endif /* defined(CyScBoostClk__CFG3) */
